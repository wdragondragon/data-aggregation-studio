...
(2047489290000010274, 'default', 0, '2026-06-09 10:00:00', '2026-06-09 10:00:00', 2047489290000000242, 'payloadMode', '发送数据形态', '发送数据形态', 'TECHNICAL', 'STRING', 'SELECT', 0, 0, 70, null, null, 'object', 1, 1, '["EQ", "LIKE", "IN"]', 'LIKE', '["object", "array"]'),
(2047489290000010276, 'default', 0, '2026-06-09 10:00:00', '2026-06-09 10:00:00', 2047489290000000242, 'dataNodePath', '目标数据节点', '目标数据节点', 'TECHNICAL', 'STRING', 'INPUT', 0, 0, 80, null, '例如：records.record', null, 1, 1, '["EQ", "LIKE", "IN"]', 'LIKE', '[]'),
(2047489290000010275, 'default', 0, '2026-06-09 10:00:00', '2026-06-09 10:00:00', 2047489290000000242, 'batchSize', '数组批量大小', '数组批量大小', 'TECHNICAL', 'INTEGER', 'NUMBER', 0, 0, 90, null, null, '500', 1, 1, '["EQ", "GT", "GE", "LT", "LE", "BETWEEN", "IN"]', 'EQ', '[]'),
(2047489290000010267, 'default', 0, '2026-06-09 10:00:00', '2026-06-09 10:00:00', 2047489290000000242, 'soapFaultFail', 'SOAP Fault 失败', 'SOAP Fault 失败', 'TECHNICAL', 'BOOLEAN', 'SWITCH', 0, 0, 100, null, null, 'true', 1, 1, '["EQ"]', 'EQ', '[]'),
(2047489290000010268, 'default', 0, '2026-06-09 10:00:00', '2026-06-09 10:00:00', 2047489290000000242, 'responseStatus.path', '业务状态节点', '业务状态节点', 'TECHNICAL', 'STRING', 'INPUT', 0, 0, 110, null, null, null, 1, 1, '["EQ", "LIKE", "IN"]', 'LIKE', '[]'),
(2047489290000010269, 'default', 0, '2026-06-09 10:00:00', '2026-06-09 10:00:00', 2047489290000000242, 'responseStatus.code', '业务成功状态码', '业务成功状态码', 'TECHNICAL', 'STRING', 'INPUT', 0, 0, 120, null, null, '200', 1, 1, '["EQ", "LIKE", "IN"]', 'LIKE', '[]'),
(2047489290000010270, 'default', 0, '2026-06-09 10:00:00', '2026-06-09 10:00:00', 2047489290000000242, 'retryTimes', '重试次数', '重试次数', 'TECHNICAL', 'INTEGER', 'NUMBER', 0, 0, 130, null, null, '3', 1, 1, '["EQ", "GT", "GE", "LT", "LE", "BETWEEN", "IN"]', 'EQ', '[]'),
(2047489290000010271, 'default', 0, '2026-06-09 10:00:00', '2026-06-09 10:00:00', 2047489290000000242, 'retryIntervalMs', '重试间隔(毫秒)', '重试间隔(毫秒)', 'TECHNICAL', 'LONG', 'NUMBER', 0, 0, 140, null, null, '1000', 1, 1, '["EQ", "GT", "GE", "LT", "LE", "BETWEEN", "IN"]', 'EQ', '[]'),
(2047489290000010272, 'default', 0, '2026-06-09 10:00:00', '2026-06-09 10:00:00', 2047489290000000242, 'connectTimeoutMs', '连接超时(毫秒)', '连接超时(毫秒)', 'TECHNICAL', 'INTEGER', 'NUMBER', 0, 0, 150, null, null, '3000', 1, 1, '["EQ", "GT", "GE", "LT", "LE", "BETWEEN", "IN"]', 'EQ', '[]'),
(2047489290000010273, 'default', 0, '2026-06-09 10:00:00', '2026-06-09 10:00:00', 2047489290000000242, 'socketTimeoutMs', '响应超时(毫秒)', '响应超时(毫秒)', 'TECHNICAL', 'INTEGER', 'NUMBER', 0, 0, 160, null, null, '3000', 1, 1, '["EQ", "GT", "GE", "LT", "LE", "BETWEEN", "IN"]', 'EQ', '[]')
on duplicate key update
  tenant_id = VALUES(tenant_id),
  deleted = VALUES(deleted),
  updated_at = VALUES(updated_at),
