...
public interface DatasourceConnectionTestRecordMapper extends BaseMapper<DatasourceConnectionTestRecordEntity> {
    ...
    @Select({
            ...
            "  and r.deleted = 0",
            "  and r.runtime_cluster_id is null",
            ...
            "      and newer.deleted = 0",
            "      and newer.runtime_cluster_id is null",
    ...
    @Select({
            "<script>",
            "select r.tenant_id, r.connection_fingerprint, r.connection_status, r.ended_at",
            "from datasource_connection_test_record r",
            "where r.tenant_id = #{tenantId}",
            "  and r.deleted = 0",
            "  and r.runtime_cluster_id is null",
    ...
    List<DatasourceConnectionTestRecordEntity> selectRecentTrendByFingerprints(@Param("tenantId") String tenantId,
                                                                               @Param("fingerprints") Collection<String> fingerprints,
                                                                               @Param("limit") int limit);
