...
alter table data_model_lineage_relation add column manual_maintainer_user_id integer;
alter table data_model_lineage_relation add column manual_maintainer_name_snapshot text;
