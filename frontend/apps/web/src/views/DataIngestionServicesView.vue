<template>
  <div class="studio-page">
    ...
    <SectionCard title="服务列表" description="发布后创建订阅 Token，外部系统即可调用接入地址。">
      <StudioTableShell min-width="1800px">
...
function buildActions(row: DataIngestionServiceListView) {
  return [
    ...
    { key: "debug", label: "调试", disabled: row.runtimeValid === false, onClick: () => { void router.push(`/data-ingestion-services/${row.id}/edit?debug=1`); } },
